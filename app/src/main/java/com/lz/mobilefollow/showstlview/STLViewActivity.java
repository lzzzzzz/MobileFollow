...
import com.lz.mobilefollow.showstlview.othershow.FileListDialog;
import com.lz.mobilefollow.showstlview.othershow.PreferencesActivity;
import com.lz.mobilefollow.showstlview.stlbean.STLObject;
import com.lz.mobilefollow.showstlview.util.IOUtils;
	...
	public void setOnListener() {
		...
		loadButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				LogUtils.i("zwc:" + Environment.getExternalStorageDirectory().getAbsolutePath());
			}
		});
